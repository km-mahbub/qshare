...
#if defined(Q_OS_WIN32)
const char *const kSeafileConfigureFileName = "qShare.ini";
const char *const kSeafileConfigurePath = "SOFTWARE\\qShare";
const int kIntervalBeforeShowInitVirtualDialog = 3000;
#else
const char *const kSeafileConfigureFileName = ".qSharerc";
#endif
...
QString SeafileApplet::getUniqueClientId()
{
    ...
    // Id file path is `~/qShare/.qShare-data/id`
